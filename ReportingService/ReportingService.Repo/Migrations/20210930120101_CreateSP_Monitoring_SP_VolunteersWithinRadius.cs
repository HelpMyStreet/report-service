...
{
    public partial class CreateSP_Monitoring_SP_VolunteersWithinRadius : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE PROCEDURE [Analysis].[SP_VolunteersWithinRadius]
	@Postcode VARCHAR(10)
...
GO
        ...
        {
            migrationBuilder.Sql(@"
                DROP PROCEDURE [Analysis].[SP_VolunteersWithinRadius]
            ");
        }
    }
}
