...
{
    public partial class CreateSP_Monitoring_SP_ExpectedNewTaskPendingApprovalNotificationEmails : Migration
    {
  ...
  INSERT INTO [Monitoring].[MonitoringTimestamps]
	VALUES (@Activity,@RunID,@Trigger,0,GETDATE(),@RowsAffected,@ProcessedTo)
        ...
        {
            migrationBuilder.Sql(@"
                DROP PROCEDURE [Monitoring].[SP_ExpectedNewTaskPendingApprovalNotificationEmails]
            ");
        }
    }
}
