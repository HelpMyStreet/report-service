...
{
    public partial class CreateSP_Monitoring_SP_JoinOncePerUserEmails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE PROCEDURE [Monitoring].[SP_JoinOncePerUserEmails]
	@Trigger VARCHAR(100)
  ...
  CREATE TABLE [#ActualEmails]
	( [RecipientUserID] INT PRIMARY KEY
  ...
  INSERT INTO [Monitoring].[MonitoringTimestamps]
	VALUES (@Activity,@RunID,@Trigger,0,GETDATE(),@RowsAffected,@ProcessedTo)
        ...
        {
            migrationBuilder.Sql(@"
                DROP PROCEDURE [Monitoring].[SP_JoinOncePerUserEmails]
            ");
        }
    }
}
