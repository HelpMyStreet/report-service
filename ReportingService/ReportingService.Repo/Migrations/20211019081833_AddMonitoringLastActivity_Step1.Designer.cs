...
namespace ReportingService.Repo.Migrations
{
    ...
    [Migration("20211019081833_AddMonitoringLastActivity_Step1")]
    partial class AddMonitoringLastActivity_Step1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReportingService.Repo.EntityFramework.Models.QuicksightRoleGroups", b =>
                {
            ...
            modelBuilder.Entity("ReportingService.Repo.EntityFramework.Models.QuicksightRoles", b =>
                {
                    ...
                    b.ToTable("Role","Quicksight");

                    b.HasData(
                        new
                        {
                            Id = -33,
                            RoleName = "AgeUKMidMersey_Admin"
                        },
                        new
                        {
                            Id = -32,
                            RoleName = "ApexBankStaff_Admin"
                        },
                        new
                        {
                            Id = -31,
                            RoleName = "Southwell_Admin"
                        },
                        new
                        {
                            Id = -23,
                            RoleName = "AgeConnectsCardiff_Admin"
                        },
                        new
                        {
                            Id = -22,
                            RoleName = "Sandbox_Admin"
                        },
                        new
                        {
                            Id = -20,
                            RoleName = "LincolnPCN_Admin"
                        },
                        new
                        {
                            Id = -17,
                            RoleName = "StamfordPCN_Admin"
                        },
                        new
                        {
                            Id = -14,
                            RoleName = "EastLindseyPCN_Admin"
                        },
                        new
                        {
                            Id = -13,
                            RoleName = "AgeUKFavershamAndSittingbourne_Admin"
                        },
                        new
                        {
                            Id = -12,
                            RoleName = "LincolnshireVolunteers_Admin"
                        },
                        new
                        {
                            Id = -11,
                            RoleName = "AgeUKSouthKentCoast_Admin"
                        },
                        new
                        {
                            Id = -10,
                            RoleName = "AgeUKNottsNorthMuskham_Admin"
                        },
                        new
                        {
                            Id = -9,
                            RoleName = "AgeUKNorthWestKent_Admin"
                        },
                        new
                        {
                            Id = -8,
                            RoleName = "AgeUKNottsBalderton_Admin"
                        },
                        new
                        {
                            Id = -7,
                            RoleName = "AgeUKWirral_Admin"
                        },
                        new
                        {
                            Id = -6,
                            RoleName = "Ruddington_Admin"
                        },
                        new
                        {
                            Id = -5,
                            RoleName = "Tankersley_Admin"
                        },
                        new
                        {
                            Id = -3,
                            RoleName = "AgeUKLSL_Admin"
                        },
                        new
                        {
                            Id = -2,
                            RoleName = "FTLOS_Admin"
                        },
                        new
                        {
                            Id = -1,
                            RoleName = "Generic_Admin"
                        });
                });

            modelBuilder.Entity("ReportingService.Repo.EntityFramework.Models.QuicksightUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Scaffolding.Models.MonitoringLastActivity", b =>
                {
                    b.Property<int>("GroupId")
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("PercentActiveWithinLast30Days")
                        .HasColumnName("% Active within last 90 days")
                        .HasColumnType("float");

                    b.Property<double?>("PercentEverActive")
                        .HasColumnName("% Ever Active")
                        .HasColumnType("float");

                    b.HasKey("GroupId");

                    b.ToTable("LastActivity","Monitoring");
                });
            ...
            modelBuilder.Entity("ReportingService.Repo.EntityFramework.Models.QuicksightRoleGroups", b =>
                {
                    b.HasOne("ReportingService.Repo.EntityFramework.Models.QuicksightRoles", "Role")
                        .WithMany("RoleGroups")
